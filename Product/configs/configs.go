...
func init() {
	...
	viper.SetConfigFile("D:/Documents/Github/CN334_Animix_Store/product/.env")
...
func GetConfig() Config {
	// // Deploy
	// echo_port, _ := strconv.Atoi(os.Getenv("ECHO_PORT_USER"))
	...
	return Config{
		App: App{
			Port: viper.GetInt("ECHO_PORT_PRODUCT"),
		},
		Db: Db{
